// Keeper flow for coins whose collection lives on another chain (Ethereum, Base, BNB, Solana).
//
// Per external vault, each pass:
//   1. price the cheapest listing on the target chain, in ETH (via a Relay quote for BNB/SOL);
